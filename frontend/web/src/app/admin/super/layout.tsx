...
const MENU = [
  ...
  { name: '결제 설정', path: '/admin/super/payments/settings' },
  ...
  return (
    <SuperAdminAuthGate>
      <div className="flex h-screen flex-col bg-gray-50">
        <header className="flex shrink-0 items-center border-b border-gray-200 bg-white px-4 py-2.5">
          <Link
            href="/"
            className="text-sm text-gray-600 transition-colors hover:text-violet-700 focus:outline-none focus-visible:rounded focus-visible:ring-2 focus-visible:ring-violet-400 focus-visible:ring-offset-2"
          >
            ← 메인으로
          </Link>
        </header>
