...
export { default as ApplicantDetailIntroSection } from './ApplicantDetailIntroSection'
...
export { default as ApplicantDetailSnsSection } from './ApplicantDetailSnsSection'
