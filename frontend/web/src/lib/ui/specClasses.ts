...
export const BTN_PRIMARY =
  'bg-[#3B82F6] text-white px-4 py-2 rounded-lg hover:bg-blue-600 w-full md:w-auto inline-flex items-center justify-center font-medium'

export const BTN_SECONDARY =
  'border border-[#E5E7EB] bg-white text-gray-900 px-4 py-2 rounded-lg w-full md:w-auto inline-flex items-center justify-center font-medium text-sm'
