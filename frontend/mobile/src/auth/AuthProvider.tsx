...
type AuthContextValue = {
  ...
  signup: (input: { email: string; password: string; nickname: string; role: 'APPLICANT' | 'AGENCY' }) => Promise<void>
  logout: () => Promise<void>
}
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const signup = useCallback(async (input: { email: string; password: string; nickname: string; role: 'APPLICANT' | 'AGENCY' }) => {
