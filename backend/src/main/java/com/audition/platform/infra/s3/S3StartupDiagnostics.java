...
public class S3StartupDiagnostics {
    ...
    public void onReady(ApplicationReadyEvent event) {
        ...
        if (!r2ServiceUp) {
            log.warn(
                    "R2 image upload disabled: set endpoint/bucket/public URL and credentials "
                            + "(R2_ENDPOINT/R2_BUCKET/R2_PUBLIC_URL or AWS_S3_ENDPOINT/AWS_BUCKET/AWS_S3_PUBLIC_BASE_URL; "
